    ...
    <Section>
      ...
      <div className="card space-y-6 text-slate-300 leading-8">
        ...
        <p>
          ...
          public. My primary interests include Artificial Intelligence, Machine
          Learning, Statistics, Software Engineering and Quantitative Finance.
        </p>
